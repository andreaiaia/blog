...
<CFImage src="giappone/meiji.jpg" alt="A Japanese Torii surrounded by green trees" />
...
<CFImage src="giappone/hanami.jpg" alt="Cherry blossoms in Ueno park" />
...
<CFImage src="giappone/godzilla.jpg" alt="Godzilla watches the street below from the rooftop of the IMAX cinema of Shinjuku" />
...
<CFImage src="giappone/kencho-ji-2.jpg" alt="The statue of a Karasu-tengu in the temple of Kenchō-ji" />
...
<CFImage src="giappone/kamakura.jpg" alt="A man flying over Kamakura beach" />
...
<CFImage src="giappone/koya-san-cimitero.jpg" alt="A Corinto, a statue that represents the five elements of the Japanese philosophy: earth, water, fire, wind, void." />
...
<CFImage src="giappone/miyajima-nasone.jpg" alt="A funny statue with a long nose in the Daisho-in temple." />
...
<CFImage src="giappone/turisti.jpg" alt="Tourists take a picture with tipical Japanese dresses while a local tries to pass." />
